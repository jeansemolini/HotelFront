...
let AppComponent = class AppComponent {
    constructor(carregarJsonService) {
...
let CarregarJsonService = class CarregarJsonService {
    constructor(http) {
        this.http = http;
    }
    carregarDadosForaHotel() {
        return this.http.get('assets/foraHotel.json').toPromise();
    }
    carregarDadosNoHotel() {
...
CarregarJsonService.ctorParameters = () => [
...
class Checkin {
    constructor(pessoa, dataEntrada, dataSaida, adicionalVeiculo) {
